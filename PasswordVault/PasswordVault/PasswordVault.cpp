...
/**
* Saves instance handle in a global variable and create and displays the main program window
*
* @param     hInstance     Unknown
* @param     nCmdShow      Unknown
* @return    bool          Unknown
*/
...
* @param     wParam      Unknown
* @param     lParam      Unknown
* @return    LRESULT     Unknown
*/
